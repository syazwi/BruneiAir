...
$countQuery = $query; // For total count
    ...
    <table class="min-w-full bg-white border border-gray-200">
      ...
      <tbody>
        ...
        <tr class="text-center">
          ...
          <td class="py-2 px-4 border"><?= $flight['flight_number'] ?></td>
          <td class="py-2 px-4 border"><?= $flight['departure'] ?></td>
          <td class="py-2 px-4 border"><?= $flight['arrival'] ?></td>
          <td class="py-2 px-4 border"><?= $flight['origin'] ?></td>
          <td class="py-2 px-4 border"><?= $flight['destination'] ?></td>
