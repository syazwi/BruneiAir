...
<head>
  ...
  <title>Aircraft Management - Staff</title>
    ...
    <table class="min-w-full bg-white border border-gray-200">
      ...
      <tbody>
        ...
        <tr class="text-center">
          ...
          <td class="py-2 px-4 border"><?= htmlspecialchars($aircraft['capacity']) ?></td>
          <td class="py-2 px-4 border"><?= htmlspecialchars($aircraft['status']) ?></td>
